Test__index = {
	...
	["test: Should return nil when accessing a element at large positive index"] = function ()
		luaunit.assertNil(array("a", "b", "c")[100])
	end;

	["test: Should return nil when accessing a element at large negative index"] = function ()
		luaunit.assertNil(array("a", "b", "c")[-100])
	end;
	...
	["test: Should return the first element when accessing with 1"] = function ()
	...
	["test: Should return the last element when accessing with -1"] = function ()
